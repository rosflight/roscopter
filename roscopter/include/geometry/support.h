...
template<typename Derived>
void setNormalRandom(Eigen::MatrixBase<Derived> & M, std::normal_distribution<double> & N,
...
template<typename Derived>
Derived randomNormal(std::normal_distribution<typename Derived::Scalar> & N,
                     std::default_random_engine & g)
{
  Derived out;
...
Eigen::Matrix<T, R, C> randomUniform(std::uniform_real_distribution<T> & N,
                                     std::default_random_engine & g)
{
