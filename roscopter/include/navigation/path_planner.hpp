...
private:
   ...
   */
  rclcpp::Subscription<roscopter_msgs::msg::State>::SharedPtr state_subscription_;
  ...
  /**
   * Service handle that clears the waypoint list and calls a clear waypoint service from the path_manager
   */
   ...
   */
  rclcpp::Service<roscopter_msgs::srv::AddWaypoint>::SharedPtr add_waypoint_service_;
   ...
   * @return True
   */
  bool update_path(const roscopter_msgs::srv::AddWaypoint::Request::SharedPtr & req,
  ...
  /**
   * @brief Callback for the roscopter_msgs::msg::State publisher. Saves the initial GNSS coordinates
   * 
   * @param msg: Pointer to a roscopter_msgs::msg::State object
   */
   ...
   */
  std::array<float, 3> lla2ned(std::array<float, 3> lla);
