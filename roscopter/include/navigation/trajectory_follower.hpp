...
private:
  ...
  Eigen::Vector4d compute_control_input(const double pn_cmd, const double pe_cmd,
                                        const double pd_cmd, const double psi_cmd, const double vn,
                                        const double ve, const double vd);
  ...
  manage_trajectory(roscopter_msgs::msg::TrajectoryCommand input_cmd, double dt) override;
