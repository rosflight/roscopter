    ...
    , input_cmd_(roscopter_msgs::msg::TrajectoryCommand())
{
  ...
  state_sub_ = this->create_subscription<roscopter_msgs::msg::State>(
    "estimated_state", 1, std::bind(&TrajectoryFollowerROS::state_callback, this, _1));
  trajectory_sub_ = this->create_subscription<roscopter_msgs::msg::TrajectoryCommand>(
    "trajectory_command", 1, std::bind(&TrajectoryFollowerROS::cmd_callback, this, _1));
  firmware_status_sub_ = this->create_subscription<rosflight_msgs::msg::Status>(
    "status", 1, std::bind(&TrajectoryFollowerROS::status_callback, this, _1));
  cmd_pub_ =
  ...
  clear_integrators_srvs_ = this->create_service<std_srvs::srv::Trigger>(
    "trajectory_follower/clear_integrators",
    std::bind(&TrajectoryFollowerROS::clear_integrators_callback, this, _1, _2));

  // Register parameter callback
  parameter_callback_handle_ = this->add_on_set_parameters_callback(
    std::bind(&TrajectoryFollowerROS::parameters_callback, this, _1));
...
TrajectoryFollowerROS::parameters_callback(const std::vector<rclcpp::Parameter> & parameters)
{
