...
ControllerCascadingPID::compute_offboard_control(roscopter_msgs::msg::ControllerCommand & input_cmd,
                                                 double dt)
{
  ...
  switch (mode) {
    ...
    default:
      ...
      RCLCPP_ERROR_STREAM(this->get_logger(),
                          "Unknown control mode! Using previous command (if any)...");
      break;
  }
...
void ControllerCascadingPID::roll_pitch_yaw_thrust_to_motor(
...
void ControllerCascadingPID::roll_pitch_yawrate_thrust_to_motor(
  roscopter_msgs::msg::ControllerCommand input_cmd)
{
  // Saturate the input commands (since we go directly to thrusts).
  double max_phi = params.get_double("max_roll_deg") * TO_RADIANS;
...
void ControllerCascadingPID::rollrate_pitchrate_yawrate_thrust_to_motor(
  roscopter_msgs::msg::ControllerCommand input_cmd)
{
...
void ControllerCascadingPID::nvel_evel_dvel_yawrate(
  roscopter_msgs::msg::ControllerCommand input_cmd)
{
...
void ControllerCascadingPID::facc_racc_dacc_yawrate(
  roscopter_msgs::msg::ControllerCommand input_cmd)
{
  double equilibrium_throttle = params.get_double("equilibrium_throttle");
  ...
  double total_acc_c = sqrt((1.0 - az) * (1.0 - az) + ax * ax + ay * ay); // (in g's)
...
void ControllerCascadingPID::nvel_evel_dpos_yawrate(
  roscopter_msgs::msg::ControllerCommand input_cmd)
{
  double vel_n = input_cmd.cmd1;
  double vel_e = input_cmd.cmd2;
...
void ControllerCascadingPID::roll_pitch_yaw_throttle(
  roscopter_msgs::msg::ControllerCommand input_cmd)
{
...
void ControllerCascadingPID::pass_to_firmware_controller(
  roscopter_msgs::msg::ControllerCommand input_cmd)
{
  ...
  if (input_cmd.mode == roscopter_msgs::msg::ControllerCommand::MODE_PASS_THROUGH_TO_MIXER) {
  ...
  } else if (input_cmd.mode
             == roscopter_msgs::msg::ControllerCommand::MODE_ROLLRATE_PITCHRATE_YAWRATE_THROTTLE) {
    ...
    max_z = params.get_double("max_yaw_rate_deg");
             ...
             == roscopter_msgs::msg::ControllerCommand::MODE_ROLL_PITCH_YAWRATE_THROTTLE) {
    ...
    RCLCPP_WARN_STREAM(this->get_logger(),
                       "Unknown command input type! Using previous command (if any)...");
    max_x = 0.0;
    max_y = 0.0;
    max_z = 0.0;
    return;
