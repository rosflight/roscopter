    ...
    : Node("rviz_waypoint_publisher")
{
  ...
  aircraft_.mesh_resource = "package://roscopter_gcs/resource/skyhunter.dae";
...
void RvizWaypointPublisher::state_update_callback(const roscopter_msgs::msg::State & msg)
{
  vehicle_state_ = msg;
  update_mesh();
}
